...
describe("Dewdate", () => {
  ...
  it("should handle invalid day constructor", () => {
    expect(() => new Dewdate(32, 1, 2023)).toThrowError(); // January has 31 days
  });

  it("should handle invalid month constructor", () => {
    expect(() => new Dewdate(15, 13, 2023)).toThrowError(); // Invalid month
  });

  it("should handle invalid year constructor", () => {
  ...
  it("should handle month overflow on increment", () => {
  ...
  it("should handle month underflow on decrement", () => {
    const dewdate = new Dewdate(15, 1, 2024);
    dewdate.decrementMonth();
    expect(dewdate.Day).toBe(15); // Day remains the same
    expect(dewdate.Month).toBe(12); // December
  ...
  it("should handle day overflow on month increment during non-leap year", () => {
  ...
  it("should handle day overflow on month increment during leap year", () => {
  ...
  it("should handle day overflow on month decrement during non-leap year", () => {
  ...
  it("should handle day overflow on month decrement during leap year", () => {
